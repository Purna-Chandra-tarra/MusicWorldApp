...
class SearchedAlbum extends StatefulWidget {
    final Album? album;
  final String? title;
  final Song? song;
  final String? albumId;
  final List<dynamic>? albumImage;
  const SearchedAlbum({super.key, this.album, this.song, this.albumId, this.albumImage, this.title});

  @override
  State<SearchedAlbum> createState() => _SearchedAlbumState();
}

class _SearchedAlbumState extends State<SearchedAlbum> with TickerProviderStateMixin  {
  ...
  Future<void> fetchSongs() async {
    try {
      final response = await http.get(Uri.parse('https://jiosavvan.vercel.app/albums?id=${widget.albumId}'));
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                          image: NetworkImage(widget.albumImage!.last['url'].toString()),
