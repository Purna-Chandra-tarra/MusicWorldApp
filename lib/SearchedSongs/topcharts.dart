...
class SearchedTopCharts extends StatefulWidget {
  final String? chartId;
  final Song? song;
  final String? title;
  final List<dynamic>? chartImage;
  const SearchedTopCharts({super.key,this.chartId,this.chartImage,this.title,
      this.song,});

  @override
  State<SearchedTopCharts> createState() => _SearchedTopChartsState();
}

class _SearchedTopChartsState extends State<SearchedTopCharts> with SingleTickerProviderStateMixin {
  ...
  Future<void> fetchSongs() async {
    try {
      ...
      final response = await http.get(Uri.parse(
          'https://jiosavvan.vercel.app/playlists?id=${widget.chartId}'));
