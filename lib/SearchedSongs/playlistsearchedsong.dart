...
class SearchPlaylist extends StatefulWidget {
  ...
  final Song? song;
  final String? title;
  final List<dynamic>? playlistImage;
  const SearchPlaylist({super.key, this.playlistId, this.title,this.song, this.playlistImage});

  @override
  State<SearchPlaylist> createState() => _SearchPlaylistState();
}

class _SearchPlaylistState extends State<SearchPlaylist> with SingleTickerProviderStateMixin {
 ...
 late ScrollController _scrollController;
  ...
  Future<void> fetchSongs() async {
    try {
      ...
      final response = await http.get(Uri.parse('https://jiosavvan.vercel.app/playlists?id=${widget.playlistId}'));
