...
class PlaylistSongsList extends StatefulWidget {
  ...
  final Song? song;
  const PlaylistSongsList({super.key, required this.playlist, this.song});
...
class _PlaylistSongsListState extends State<PlaylistSongsList> with SingleTickerProviderStateMixin {
 ...
 late ScrollController _scrollController;
  ...
  Future<void> fetchSongs() async {
    try {
      ...
      final response = await http.get(Uri.parse('https://jiosavvan.vercel.app/playlists?id=${widget.playlist.id}'));
                ...
                child: Column(
                  children: [
                    if (widget.playlist != null &&
                          widget.playlist.image.isNotEmpty)
                        ClipRRect(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                image: NetworkImage(
                                    widget.playlist.image.last['link']),
                        ...
                        SizedBox(height: 10,),
                        Text(widget.playlist.title, style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold,color: Colors.red),),
                    Expanded(
                      child: songs.isEmpty
                          ? Center(
